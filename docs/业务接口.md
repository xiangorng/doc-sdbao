...
<vuep template="#interface_实际退款同步请求"></vuep>
<script v-pre type="text/x-template" id="interface_实际退款同步请求">
module.exports = {
  template: '<div><i-table :items="interfaces" :columns="columns"></i-table></div>',
  data () {
    return {
      name: 'Vuep',
      columns: columns.interface,
      interfaces: interfaces.实际退款同步请求
    }
  }
}
</script>
...
<vuep template="#interface_实际退款同步返回"></vuep>
<script v-pre type="text/x-template" id="interface_实际退款同步返回">
module.exports = {
  template: '<div><i-table :items="interfaces" :columns="columns"></i-table></div>',
  data () {
    return {
      name: 'Vuep',
      columns: columns.interface,
      interfaces: interfaces.实际退款同步返回
    }
  }
}
</script>